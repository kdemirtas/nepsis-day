...
2. **Own public repo, `kdemirtas/nepsis-day`, at `~/code/personal/web/nepsis-day/`.** Kerem's call, 2026-09-12. Cloudflare Pages deploys from a public repo; the app repo stays private. A new type folder `web/` beside `cli/` and `mobile-app/` (⏳ one line in `~/code/personal/CLAUDE.md`).
